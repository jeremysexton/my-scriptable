...
var chooseEpisode = new Alert();
chooseEpisode.title = "Which episode are you logging?";
seasonEpisodes.forEach((episode) => {
	let name = episode["name"];
	let number = episode["episode_number"];
	let option = `#${number}: ${name}`;
	chooseEpisode.addAction(option);
});
var chosenEpisodeIndex = await chooseEpisode.present();
var chosenEpisode = seasonEpisodes[chosenEpisodeIndex];
